...
double Kp1=6,Ki1=0.1,Kd1=0,LErro1=0,LErro2=0,LErro3=0,RErro1=0,RErro2=0,RErro3=0;
/**
  * @brief    将当前位置清零
  * @param    addr  ：电机地址
...
int16_t Left(double singal_angke,double angle,int16_t speed)
{
  LErro1=angle-singal_angke;
  LErro3+=LErro1;
  if(LErro3>=20)LErro3=20;
  else if(LErro3<=-20)LErro3=-20;
  speed=Kp1*LErro1+Kd1*(LErro1-LErro2)+Ki1*LErro3;
...
int16_t Right(double singal_angke,double angle,int16_t speed)
{
  RErro1=angle-singal_angke;
   RErro3+=RErro1;
  if(RErro3>=20)RErro3=20;
  else if(RErro3<=-20)RErro3=-20;
  speed=Kp1*RErro1+Kd1*(RErro1-RErro2)+Ki1*RErro3;
  if(speed>=100)speed=100;
  else if(speed<=-100)speed=-100;
  RErro2=RErro1;
  return speed;
